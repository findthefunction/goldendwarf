...
def wrrrdcloud():
    ...
    stopwords.update(["the", "a", "are", "they", "in", "we", "is", "tweet","retweet", "feg", "fegarmy", "rt", "giveaway", "give away"])
    ...
    wc = WordCloud(background_color="white", max_words=1000, mask=transformed_eth_mask,
               stopwords=stopwords, contour_width=3, contour_color='violet', width=200,height=100)
